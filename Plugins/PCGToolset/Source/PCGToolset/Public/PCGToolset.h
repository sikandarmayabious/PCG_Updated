...
public:
	...
	/** Group existing graph parameters without changing their IDs, values or instance overrides. */
	UFUNCTION(meta = (AICallable), Category = "PCG|GraphParams")
	static bool SetGraphParameterCategories(UPCGGraph* Graph, const TMap<FName, FString>& Categories);
	...
	*/
	...
	static UPCGExecuteGraphInstanceAsyncResult* ExecuteGraphInstance(const AActor* PCGVolume); // @todo_pcg: Running on a PCG Volume isn't ideal long term
	...
	static FInstancedPropertyBag GetGraphInstanceParams(const AActor* PCGVolume);
	 ...
	 */
	UFUNCTION(meta = (AICallable), Category = "PCG|GraphInstanceParams")
	static bool SetGraphInstanceParams(const AActor* PCGVolume, const FString& JsonParams);
	 ...
	 */
	UFUNCTION(meta = (AICallable), Category = "PCG|GraphInstanceParams")
	static bool ResetGraphInstanceParams(const AActor* PCGVolume, const TArray<FName>& ParamNames);
